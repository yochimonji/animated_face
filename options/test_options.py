...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--checkpoint_path', default='checkpoint/best_model.pt', type=str, help='Path to pSp model checkpoint')
		self.parser.add_argument('--data_path', type=str, default='images', help='Path to directory of images to evaluate')
